...
class Articulo extends CI_Controller {
	...
	public function index()	{
		$data=array('articulo'=>$this->Modelo_Articulo->listar(),'clasificacion' => $this->Modelo_Clasificacion->listar(),'marca'=>$this->Modelo_Marca->listar());
		$this->load->view('adm/superior');
		$this->load->view('registro/articulos',$data);
